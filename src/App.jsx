...
const caseStudies = [
  {
    id: 1,
    title: 'Emergency Concrete Repair During Shutdown – Seawater Sump',
    industry: 'Oil & Gas – Saudi Chevron',
    problem: 'During a scheduled 12-day shutdown, extensive concrete deterioration was identified inside the seawater return sump. The original specification called for epoxy patch repair mortar, but an active Cathodic Protection (CP) system made epoxy repair unsuitable under site conditions.',
    rootCause: 'Incompatibility between the active CP system and epoxy repair mortar, combined with the tight 12-day shutdown window that could not accommodate the standard 7-day curing period required for conventional cementitious repair before coating and return to service.',
    investigation: 'Reviewed the repair constraints against shutdown duration, assessed CP system configuration and interference risks, evaluated available repair materials for early strength gain, and determined the minimum curing time required to proceed with protective coating within schedule.',
    solution: 'Specified cementitious repair mortar with controlled halogen light curing applied during the initial setting period to accelerate early strength development. Curing compound was applied immediately after initial hardening, followed by protective coating application within the available shutdown window.',
    result: 'Repair completed successfully within the 12-day shutdown period. The sump returned to service on schedule without delaying plant startup. Repair quality and long-term durability were maintained without compromising the CP system.',
    technologies: ['Cementitious Repair Mortar', 'Halogen Light Curing', 'Cathodic Protection Systems', 'Curing Compound Application', 'Protective Coating'],
    background: 'Saudi Chevron scheduled a 12-day plant shutdown to carry out maintenance on the seawater return sump. During the inspection phase, widespread concrete deterioration was discovered that required immediate remediation before the sump could return to service. The existing Cathodic Protection (CP) system added a critical constraint to material selection.',
    challenge: 'Epoxy repair mortar was originally specified but was found to be incompatible with the active CP system. Switching to cementitious mortar introduced a new constraint – standard curing requires a minimum of seven days before protective coating can be applied, which risked overrunning the 12-day shutdown window and delaying plant startup.',
    technicalAssessment: 'A systematic review of the repair material options was conducted against three criteria: CP system compatibility, early strength development timeline, and the total coating and reinstatement schedule within the shutdown duration. The objective was to identify a repair approach that met all three constraints simultaneously.',
    calculations: 'Curing time optimisation based on halogen light heat output, ambient temperature, and target 24-hour compressive strength threshold for coating adhesion. Assessment confirmed that accelerated curing under controlled halogen lighting could achieve sufficient substrate strength to permit coating within the shutdown schedule.',
